...
mkdir -p models/yolo models/face models/fire models/animal models/lpd

echo "[*] Downloading YOLO-World weights..."
...
echo "[*] Downloading Fire/Smoke weights..."
...
echo "[*] Downloading License Plate Detection weights..."
